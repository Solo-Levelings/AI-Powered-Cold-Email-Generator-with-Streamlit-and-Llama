...
class Chain:
    ...
    def extract_jobs(self, cleaned_text):
        ...
        try:
            ...
            raise OutputParserException("Context too big. Unable to parse jobs. Try With Different Website")
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Tejas, a Software Developer At XYZ. XYZ is an Software Consulting company dedicated to facilitating
            ...
            Remember you are Tejas, SDE at XYZ. 
